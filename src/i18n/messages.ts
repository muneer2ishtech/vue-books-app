export default {
  en: {
    ...
    homeDescription: 'Book management application built with Vue.js',
    previous: 'Previous',
    next: 'Next',
    pageLabel: 'Page',
    ofLabel: 'of',
    ...
    homeDescription: 'Vue.js:lla toteutettu kirjojen hallintasovellus',
    previous: 'Edellinen',
    next: 'Seuraava',
    pageLabel: 'Sivu',
    ofLabel: '/',
  ...
  sv: {
    ...
    homeDescription: 'Bokhanteringsapplikation byggd med Vue.js',
    previous: 'Foregaende',
    next: 'Nasta',
    pageLabel: 'Sida',
    ofLabel: 'av',
